	...
	<div class="main">
		<div class="content">
			<div class="room">
				...
				<div class="confirm">
					<form id = "way" method="post" action="cancellation_user.php">
					...
					if(isset($_POST['cancel']))
					{
						...
						if(isset($_POST['cancels']) && isset($_POST['select']))
						{
							...
							if (!empty($_POST['select']))
							{
    							...
    							{
        							echo $value."<br>";
									$result = mysql_query("Delete from reservation_detail Where res_id = '$new' and resSeat = '$value' and user_id = $user") or die("Select Ticket");
									$fl = true;
    							}
							}
						}
