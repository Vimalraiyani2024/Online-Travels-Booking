...
<?php /*
		...
		<br><h1 align='center'> Welcome <?php echo "<font color='#0000F'><b>".ucfirst($name)."</b></font>"; ?> To  Bus Online Booking </h1>
		<p>Welcome to the world of online bus booking. It provides you many features like, Online Book Your Tickets, Edit Your profile, Cancel Your Tickets.</p>

		<p>	Thank you for Be With Us. </p>
