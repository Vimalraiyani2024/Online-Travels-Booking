...
<?php /*
		...
		<br><h1 align='center'> FeebBack List <b></h1>
		<div class="feedback_list" align="center"> 
		<table border="1">
		<tr align="justify"><th>Sr. No <th> Name <th> Email Id <th> Mobile No. <th> FeedBack </tr>
		<?php
			include('connect.php');
			$result = mysql_query('select * from feedback') or die(mysql_error());
			while($r = mysql_fetch_array($result))
				echo "<tr><td>".$r['srno']."<td>".$r['name']."<td>".$r['email']."<td>".$r['mobile']."<td>".$r['description']."</tr>";
		?>
		</table>
		</div>
</div>
