...
<div class="wrap">
	<div class="main">
		<div class="profile_content">
			...
			<tr><td><u><a href="cpassword_user.php">Change Password</a></u></tr>
			<?php
				include('connect.php');
				if((isset($_POST['update'])) && !$err)
				{
					...
					$result = mysql_query("update user_detail set name='$nam',address='$ad',city='$city',mobile='$mob',email='$mail' Where user_id = '$user'") or die(mysql_error()); 
