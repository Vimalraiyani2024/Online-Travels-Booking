		...
		<div class="res_online">
			...
			<div class="span_of_2">
				<div class="span2_of_1">
					<form id = "way" method="post" action="reservation_operator.php">
...
<?php
	...
	if(isset($_POST['booknow']))
	{
		...
		header("location:operator_booking_search.php?searchfrom=".$searchfrom."&searchto=".$searchto."&searchdate=".$searchdate."&searchperson=".$searchperson."");
	}
?>	
